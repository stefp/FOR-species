...
Repository for the work related to the tree species classification using proximally sensed laser scanning data (TLS, MLS, ULS). This work is part of the COST action 3DForEcoTech ([https://3dforecotech.eu/](https://3dforecotech.eu/)) and co-funded by SmartForest ([smartforest.no](https://smartforest.no/))
